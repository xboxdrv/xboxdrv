...
HamaCruxNames::HamaCruxNames(ControllerMessageDescriptor& desc) :
  crouch(desc.key().put(KeyName("crouch"))),
  run(desc.key().put(KeyName("run"))),
  talk(desc.key().put(KeyName("talk"))),
  
  esc(desc.key().put(KeyName("escape"))),
  pause(desc.key().put(KeyName("pause"))),
  option(desc.key().put(KeyName("option"))),
 
  quickload(desc.key().put(KeyName("quickload"))),
  quicksave(desc.key().put(KeyName("quicksave"))),
  print(desc.key().put(KeyName("print"))),

  n1(desc.key().put(KeyName("n1"))),
  n2(desc.key().put(KeyName("n2"))),
  n3(desc.key().put(KeyName("n3"))),
  n4(desc.key().put(KeyName("n4"))),
  n5(desc.key().put(KeyName("n5"))),
  n6(desc.key().put(KeyName("n6"))),

  n7(desc.key().put(KeyName("n7"))),
  n8(desc.key().put(KeyName("n8"))),
  n9(desc.key().put(KeyName("n9"))),
  n10(desc.key().put(KeyName("n10"))),
  n11(desc.key().put(KeyName("n11"))),

  up(desc.key().put(KeyName("up"))),
  down(desc.key().put(KeyName("down"))),
  left(desc.key().put(KeyName("left"))),
  right(desc.key().put(KeyName("right"))),
  q(desc.key().put(KeyName("q"))),
  e(desc.key().put(KeyName("e"))),

  c1(desc.key().put(KeyName("c1"))),
  tab(desc.key().put(KeyName("tab"))),
  c2(desc.key().put(KeyName("c2"))),
  c3(desc.key().put(KeyName("c3"))),
  c4(desc.key().put(KeyName("c4"))),
  reload(desc.key().put(KeyName("reload"))),
  use(desc.key().put(KeyName("use"))),
  c8(desc.key().put(KeyName("c8"))),
  p2(desc.key().put(KeyName("p2"))),
  n(desc.key().put(KeyName("n"))),

  c5(desc.key().put(KeyName("c5"))),
  c6(desc.key().put(KeyName("c6"))),
  c7(desc.key().put(KeyName("c7"))),
  p1(desc.key().put(KeyName("p1"))),
  space(desc.key().put(KeyName("space")))
{
}
