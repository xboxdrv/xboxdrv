...
bool
FirestormDualController::parse_vsb(uint8_t const* data_in, int len, ControllerMessage* msg_out)
{
  if (len == 6)
  {
...
bool
FirestormDualController::parse_default(uint8_t const* data_in, int len, ControllerMessage* msg_out)
{
  if (len == 7)
  {
    ControllerMessage& msg = *msg_out;
...
bool
FirestormDualController::parse(uint8_t const* data, int len, ControllerMessage* msg_out)
{
  if (is_vsb)
  {
