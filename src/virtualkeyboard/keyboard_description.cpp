...
KeyboardDescription::create_us_layout()
{
  ...
  desc.set_key( 2, 0, Key(KEY_F1, Key::kFunction, "F2"));
  desc.set_key( 3, 0, Key(KEY_F1, Key::kFunction, "F3"));
  desc.set_key( 4, 0, Key(KEY_F1, Key::kFunction, "F4"));
  desc.set_key( 5, 0, Key(KEY_F1, Key::kFunction, "F5"));
  desc.set_key( 6, 0, Key(KEY_F1, Key::kFunction, "F6"));
  desc.set_key( 7, 0, Key(KEY_F1, Key::kFunction, "F7"));
  desc.set_key( 8, 0, Key(KEY_F1, Key::kFunction, "F8"));
  desc.set_key( 9, 0, Key(KEY_F1, Key::kFunction, "F9"));
  desc.set_key(10, 0, Key(KEY_F1, Key::kFunction, "F10"));
  desc.set_key(11, 0, Key(KEY_F1, Key::kFunction, "F11"));
  desc.set_key(12, 0, Key(KEY_F1, Key::kFunction, "F12"));
  ...
  desc.set_key(11, 1, Key(KEY_F1, Key::kLetter, "-", "_"));
  ...
  desc.set_key( 1, 2, Key(KEY_F1, Key::kLetter, "q", "Q"));
  desc.set_key( 2, 2, Key(KEY_F1, Key::kLetter, "w", "W"));
  desc.set_key( 3, 2, Key(KEY_F1, Key::kLetter, "e", "E"));
  desc.set_key( 4, 2, Key(KEY_F1, Key::kLetter, "r", "R"));
  desc.set_key( 5, 2, Key(KEY_F1, Key::kLetter, "t", "T"));
  desc.set_key( 6, 2, Key(KEY_F1, Key::kLetter, "y", "Y"));
  desc.set_key( 7, 2, Key(KEY_F1, Key::kLetter, "u", "U"));
  desc.set_key( 8, 2, Key(KEY_F1, Key::kLetter, "i", "I"));
  desc.set_key( 9, 2, Key(KEY_F1, Key::kLetter, "o", "O"));
  desc.set_key(10, 2, Key(KEY_F1, Key::kLetter, "p", "P"));
  ...
  desc.set_key( 1, 3, Key(KEY_F1, Key::kLetter, "a", "A"));
  desc.set_key( 2, 3, Key(KEY_F1, Key::kLetter, "s", "S"));
  desc.set_key( 3, 3, Key(KEY_F1, Key::kLetter, "d", "D"));
  desc.set_key( 4, 3, Key(KEY_F1, Key::kLetter, "f", "F"));
  desc.set_key( 5, 3, Key(KEY_F1, Key::kLetter, "g", "G"));
  desc.set_key( 6, 3, Key(KEY_F1, Key::kLetter, "h", "H"));
  desc.set_key( 7, 3, Key(KEY_F1, Key::kLetter, "j", "J"));
  desc.set_key( 8, 3, Key(KEY_F1, Key::kLetter, "k", "K"));
  desc.set_key( 9, 3, Key(KEY_F1, Key::kLetter, "l", "L"));
  ...
  desc.set_key( 2, 4, Key(KEY_F1, Key::kLetter, "y", "Y"));
  desc.set_key( 3, 4, Key(KEY_F1, Key::kLetter, "x", "X"));
  desc.set_key( 4, 4, Key(KEY_F1, Key::kLetter, "c", "C"));
  desc.set_key( 5, 4, Key(KEY_F1, Key::kLetter, "v", "V"));
  desc.set_key( 6, 4, Key(KEY_F1, Key::kLetter, "b", "B"));
  desc.set_key( 7, 4, Key(KEY_F1, Key::kLetter, "n", "N"));
  desc.set_key( 8, 4, Key(KEY_F1, Key::kLetter, "m", "M"));
  ...
  // row 5
  desc.set_key( 0, 5, Key(KEY_F1, Key::kModifier, "Ctrl", "", "", 2, 1));
  desc.set_key( 2, 5, Key(KEY_F1, Key::kModifier, "Win"));
  desc.set_key( 3, 5, Key(KEY_F1, Key::kModifier, "Alt", "", "", 2, 1));
  desc.set_key( 5, 5, Key(KEY_SPACE, Key::kModifier, "Space", "", "", 3, 1));
  desc.set_key( 8, 5, Key(KEY_F1, Key::kModifier, "Alt", "", "", 2, 1));
  desc.set_key(10, 5, Key(KEY_F1, Key::kModifier, "Win"));
  desc.set_key(11, 5, Key(KEY_F1, Key::kModifier, "Menu"));
  desc.set_key(12, 5, Key(KEY_F1, Key::kModifier, "Ctrl", "", "", 2, 1));
